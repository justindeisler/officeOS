...
import{n as N,_}from"./index-B9wpeZVf.js";const n=N("db");let i=null,o=null;function s(){return typeof window<"u"&&"__TAURI__"in window&&!!window.__TAURI__}async function d(){return i||o||(o=(async()=>{if(!s())return n.info("[Accounting DB] Web mode detected - using REST API for data"),{select:async()=>[],execute:async()=>({rowsAffected:0}),close:async()=>{}};const{default:e}=await _(async()=>{const{default:T}=await import("./index-DKLwIOGN.js");return{default:T}},__vite__mapDeps([0,1]));return i=await e.load("sqlite:personal-assistant.db"),await A(i),i})(),o)}async function A(e){await e.execute(`
